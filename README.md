...
**Phase 2.5 is planned but not started.** It is broken into five spikes — see [`android-shell/spikes/`](./android-shell/spikes/) for individual task briefs and device-testing notes.
